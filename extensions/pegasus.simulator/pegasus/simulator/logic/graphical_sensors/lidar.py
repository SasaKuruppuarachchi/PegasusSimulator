...
from isaacsim.sensors.experimental.rtx import Lidar as RtxLidar
...
class Lidar(GraphicalSensor):
    ...
    def initialize(self, vehicle):
        ...
        RtxLidar.create(
            ...
            translations=np.array([[self._position[0], self._position[1], self._position[2]]]),
            orientations=np.array([[self._orientation[3], self._orientation[0], self._orientation[1], self._orientation[2]]])
        )
        self._stage_prim_path = self._vehicle.prim_path + "/body/" + self._lidar_name
